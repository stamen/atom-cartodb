...
export default function tileMillExport(projectFilename = null) {
  ...
  return new File(projectFilename)
    ...
    .then(project => {
      return new Promise((resolve, reject) => {
        ...
        var mmlPath = path.join(path.dirname(projectFilename), `${path.basename(projectFilename, ".yml")}.mml.hbs`);
