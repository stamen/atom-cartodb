...
L.CartoDBGroupLayerBase = L.TileLayer.extend({
  ...
  includes: [
    ...
    cdb.geo.CartoDBLayerCommon.prototype
  ],
  ...
  initialize: function (options) {
    ...
    cdb.geo.LayerDefinition.call(this, this.options.layer_definition, this.options);

    this.fire = this.trigger;

    cdb.geo.CartoDBLayerCommon.call(this);
...
L.CartoDBGroupLayer = L.CartoDBGroupLayerBase.extend({
  includes: [
    cdb.geo.LayerDefinition.prototype,
  ],
...
L.NamedMap = L.CartoDBGroupLayerBase.extend({
  ...
  initialize: function (options) {
    ...
    cdb.geo.NamedMap.call(this, this.options.named_map, this.options);
