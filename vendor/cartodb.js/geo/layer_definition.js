...
MapBase.prototype = {
  ...
  fetchAttributes: function(layer_index, feature_id, columnNames, callback) {
    ...
    request({
      json: true,
      uri: this._attributesUrl(layer_index, feature_id)
    }, function(err, rsp, data) {
      loadingTime.end();
  ...
  getSubLayer: function(index) {
    ...
    layer.sub = layer.sub || cdb.geo.SubLayerFactory.createSublayer(layer.type, this, index);
    return layer.sub;
  },
...
cdb.geo.LayerDefinition = LayerDefinition;
